...
public class LoadClass 
{
	...
	// In accordo con l'applicazione del pattern Singleton, è stato creato l'attributo instance,
	// il costruttore è vuoto ed è stato indicato il metodo statico getInstance()
